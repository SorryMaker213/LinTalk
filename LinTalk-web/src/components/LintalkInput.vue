<template>
  ...
  >
    <div v-if="props.label" class="lintalk-input-label" :class="{ readonly: props.readonly }">
      {{ props.label }}
    </div>
    <input
      ref="inputRef"
      ...
      @input="handleInput"
    />
    <div v-if="props.limit" class="lintalk-input-limit">
