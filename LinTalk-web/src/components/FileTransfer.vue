<template>
  <template v-if="visible">
    <lintalk-draggable-window v-if="!isReady" :rounded="20" :resize="false">
      <div class="file-answer">
        <div class="answer-content-wrapper">
          <lintalk-avatar :info="props.targetInfo" class="mr-[10px]" />
    ...
    </lintalk-draggable-window>
    <lintalk-draggable-window v-if="isReady" :rounded="10" :resize="false">
      <div class="file-receive">
        <lintalk-circle-progress :progress="progress" :size="60" :strokeWidth="6" />
...
import LintalkDraggableWindow from '@/components/LintalkDraggableWindow.vue'
import LintalkAvatar from '@/components/LintalkAvatar.vue'
import LoadingDots from '@/components/LoadingDots.vue'
import LintalkCircleProgress from '@/components/LintalkCircleProgress.vue'
