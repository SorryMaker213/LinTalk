<template>
  <template v-if="visible">
    ...
    >
      <div class="audio-call" :class="{ reduced: isReduced }">
        <div class="audio-call-info">
          <lintalk-avatar :info="props.targetInfo" class="info-avatar" @click="isReduced = false" />
    ...
    <!--  视频通话-->
    <lintalk-draggable-window v-if="isReady && !props.isOnlyAudio" :rounded="20" :resize="false">
