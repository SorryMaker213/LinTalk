  ...
  <div class="msg" :class="{ right: props.right }">
    ...
    <transition name="fade">
      ...
      >
        ...
        <lintalk-tooltip v-if="right" content="撤回">
          <lintalk-icon-button @click="onRecallMsg" size="24px" font-size="16px" icon="icon-chehui" />
        </lintalk-tooltip>
        <lintalk-tooltip @click="handlerCopy" content="复制">
          <lintalk-icon-button size="24px" font-size="16px" icon="icon-fuzhi" />
        </lintalk-tooltip>
      </div>
    </transition>
  </div>
